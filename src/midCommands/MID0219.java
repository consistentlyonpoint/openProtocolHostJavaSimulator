...
public class MID0219 {
    ...
    public HashMap<String, HashMap<String, Object>> controllerString(String controllerMsg, String midCommand, String midLengthString, String midRevision) {
        ...
        try {
            //
            int[] relayFunctionNumberIdxByteRange = {20, 23};
            controllerHash.put("RELAY_FUNCTION_NUMBER", controllerMsg.substring(relayFunctionNumberIdxByteRange[0], relayFunctionNumberIdxByteRange[1]));
            //
