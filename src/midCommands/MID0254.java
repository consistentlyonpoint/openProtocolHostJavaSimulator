...
public class MID0254 {
    ...
    //
    // MID 0254 Selector control green lights
        ...
        try {
            ...
            for (int csp = 26; csp < 35; csp++) {
                ...
                switch (greenLightCommandPositionValue) {
                    case "0":
                        controllerHash.put("GREEN_LIGHT_COMMAND_SELECTOR_POSITION" + csp, "Off");
                        break;
                    case "1":
                        controllerHash.put("GREEN_LIGHT_COMMAND_SELECTOR_POSITION" + csp, "Steady");
                        break;
                    default:
                        controllerHash.put("GREEN_LIGHT_COMMAND_SELECTOR_POSITION" + csp, "Flashing");
                        break;
                }
                csp += 1;
            }
